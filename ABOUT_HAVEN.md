...
- **Safe + AllowanceModule — RETIRED (epic #1440).** Not frozen: no account can
  ...
  (#1987/#1988/#1989). **Existing Safe rows are untouched and still readable to a
  direct database query, but since #2413 no Haven surface displays them** —
  balances, tokens, agents and history no longer render. `POST /safe/exec` stays open for
