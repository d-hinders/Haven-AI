...
4. A live claim (the holder's last comment about it < 24h ago, no `🔓 RELEASE` since — and, for you as a reader, any other contrary signal) means: pick something else, or coordinate in #1289 first. Never silently duplicate a claimed build.
