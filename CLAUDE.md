...
(#2639). Where it and the code disagree, the code wins.
...
overlays. A grey inner wrapper
"grouping" siblings creates a phantom tier and fights the parent Card's lift.
See `/design-system` → "Surface hierarchy".
