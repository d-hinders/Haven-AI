...
| `@haven/frontend` | Next.js dashboard: onboarding, wallets, agent rules, activity, custody/recovery, catalog, and guarded reporting. No approvals surface: `ApprovalQueue`, the `/approvals` route, the sidebar entry and its count badge were deleted by #1989/#2055 — see the row above. |
