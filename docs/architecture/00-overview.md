...
deleted (#1987/#1988/#1989). Existing Safe accounts stay readable; Haven has no
...
| `@haven/frontend` | Next.js dashboard: onboarding, wallets, delegation agent rules, activity, custody/recovery, catalog, and guarded reporting; legacy Safe accounts remain readable without legacy authority-management controls, while identity editing, unlink, archive, and history remain available where applicable. No approvals surface: `ApprovalQueue`, the `/approvals` route, the sidebar entry and its count badge were deleted by #1989/#2055. |
