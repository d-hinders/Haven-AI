...
database query, but since #2413 no Haven surface displays them; Haven has no
...
- **Safe + AllowanceModule — RETIRED (epic #1440).** Existing Safe accounts
  keep their rows and their owners keep on-chain control, but no Haven surface
  renders them (#2413) and the rail is
