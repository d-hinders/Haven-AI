...
deleted (#1987/#1988/#1989). Existing Safe rows are untouched and still readable to a direct
database query, but since #2413 no account, agent or dashboard surface displays them; Haven has no
...
- **Safe + AllowanceModule — RETIRED (epic #1440).** Existing Safe accounts
  ...
  dashboard surface renders them (#2413 — the transactions picklists are the named
  exception, having no rail predicate) and the rail is
