...
> Safe accounts stay readable but cannot spend, and their blast radius shrinks
> accordingly — Haven can no longer construct or relay an agent transfer on this
> rail at all. The Smart Sessions **session rail is retired** too (#834):
