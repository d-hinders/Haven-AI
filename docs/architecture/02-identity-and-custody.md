...
> Safe accounts stay readable, but Haven cannot execute legacy agent payments
> from them. Any residual Safe permission remains on-chain and is managed
