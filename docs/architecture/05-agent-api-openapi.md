...
The enforcement clause above (`on-chain Safe allowance = enforcement`) describes
the **legacy AllowanceModule rail**, which is **RETIRED** (#1440): closed to new
...
cannot spend, so read that clause as a historical baseline. The Smart Sessions
