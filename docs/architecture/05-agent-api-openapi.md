...
138 registered routes, **12 of them undocumented** across 2 deferred modules.
...
ceilings from 18 modules / 90 routes to 2 / 12 — only safe-deploy.ts and safe-exec.ts remain, both under the #1440 Safe-rail caveat.) That was invisible until the
