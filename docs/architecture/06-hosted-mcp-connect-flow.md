...
**That 410's RAIL SCOPE is the correction** — the banner above says "the legacy
rail", not "hosted x402", and the difference is the whole point. This section
previously said hosted x402 worked for **no** account, reasoning from a second
claim — that the
