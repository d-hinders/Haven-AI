...
- The edge-signer surface serves the **legacy AllowanceModule rail** — which
  ...
  documented as-is because its code is still present (deleted by #1987/#1988);
  nothing here is a path a caller can complete today.
