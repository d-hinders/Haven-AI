...
| 4 | [x402 Payment Sequence](04-x402-payment-sequence.md) | Standard SDK/local MCP, hosted generic split, hosted paid-MCP three-call fast path, restart-recovery context rehydration, the #2145 funded-but-undelivered resume trigger, and the #2290 signing leg that makes it actionable. |
