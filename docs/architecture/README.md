...
- **One live policy rail.** Docs 1–5 primarily describe the
  **legacy AllowanceModule rail**, which is **RETIRED** (#1440): closed to new
  ...
  its machinery deleted (#1987/#1988/#1989). Existing Safe rows stay readable to a
