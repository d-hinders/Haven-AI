...
| `mcp-runtime-compatibility-last-verified-chain-2026-09-03.md` | The pre-0.1.29 tail of `mcp-runtime-compatibility.md`'s `last-verified` chain, moved verbatim during the #2477 compaction | The live `last-verified:` line in `docs/operations/mcp-runtime-compatibility.md` |
| [decision-log.md](decision-log.md) | Append-only record of the owner decisions, superseded decisions and retirement closures behind Haven's current rules, moved out of `CLAUDE.md` by #2639. | n/a — this is the canonical record; the current rule is in [CLAUDE.md](../../CLAUDE.md). |
