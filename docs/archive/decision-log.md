...
| Date | Decision | Refs |
|---|---|---|
| 2026-09-26 | Promotions merge behind by the owner; the post-promotion sync-back is dropped | #3325, #3365 |
...
and the owner merges each promotion behind from the web UI or API.
