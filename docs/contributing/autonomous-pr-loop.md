...
finish a round: the loop measured 195 issues filed against 199 PRs merged in the
week to 2026-09-08, three quarters of them spawned by other issues from the same
week, and the promotion digest now prints the filed-per-closed ratio and the
