...
all three, after PR #2314 wrote `Refs #2276` in its body and closed #2268 anyway
from a commit message that only *described* the incident. Two consequences worth
stating: a code fence or blockquote is **not** an escape, because GitHub parses
those too, and the way to write about the keyword is a form GitHub does not parse
