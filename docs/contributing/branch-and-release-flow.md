...
| `publish.yml` | push to `dev` | **dev channel** ([#2421](https://github.com/d-hinders/Haven-AI/issues/2421)): publishes a `0.0.0-dev.<ts>.<sha>` snapshot of all five packages under the `dev` tag. Same file, by necessity — npm trusted publishing is pinned to the workflow filename |
