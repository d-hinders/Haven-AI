...
loop (`autonomous-pr-loop.md`): when the coupling gate flags implicated docs, run
the doc reviewer and update them before opening the PR. Advisory in this phase —
