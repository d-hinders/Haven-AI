...
last-verified: "2026-08-22" # #1843: the bullet list re-read against `docs-quality-system.md` and `scripts/docs/*`; gains the chain rule for `last-verified` (the other four bullets were still accurate and are unchanged)
---
