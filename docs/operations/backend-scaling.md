...
- **Allowance-nonce coordination on every legacy-rail sign-hash builder —
  ...
  > `agent_allowances` and `approval_requests` split out to #2020 and #2021
