...
**legacy AllowanceModule** record is not shown in Haven at all since #2413 — the
row persists but reaches no screen, and it has no payment-credential or
