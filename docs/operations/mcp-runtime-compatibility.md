...
Until then rule 5 above fires: the connector refuses before any side effect,
which is the correct behaviour for an id it does not know. Note what that
