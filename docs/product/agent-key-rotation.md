...
- **Delegation-rail accounts only.** Agents on the legacy Safe AllowanceModule rail
  ...
  delegation, so there is nothing to revoke and re-issue. Their records persist as rows but reach no
  account or agent screen since #2413, and Haven offers no payment-credential,
