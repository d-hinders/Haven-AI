...
for agent payments today; attaching them when they do exist is #956). Partner
feedback (2026-07-16) showed that plain "receipt"/"kvitto" reads as the
merchant's document and overpromises.
