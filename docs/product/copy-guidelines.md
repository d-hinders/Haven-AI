...
### Never claim the books are done ([#491](https://github.com/d-hinders/Haven-AI/issues/491), enforced by the copy gate since [#2859](https://github.com/d-hinders/Haven-AI/issues/2859), and over the message catalog — where the accounting copy lives — since [#3347](https://github.com/d-hinders/Haven-AI/issues/3347))
