...
- Financial values, counts, and numeric metadata use `.v2-tabular`.
...
- For app-shell changes, verify sidebar active state, Approvals badge, TopBar back links, skip link, and mobile navigation.
