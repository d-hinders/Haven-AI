...
`components/marketing/BrandBandButton.tsx:74` and the `InvestorButton` helper at
`investor-briefing/page.tsx:548`. More than 2 is a new hand-copy; fewer means one was
