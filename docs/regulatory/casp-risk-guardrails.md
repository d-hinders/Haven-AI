...
last-verified: "2026-08-12" # #1328 mpp_demo retirement (see Verification log + EOF entry) + same-day dev: release 0.1.23-alpha.0: version constants/pins re-verified, no perimeter change (ships the Node-22 engines floor to npm); prior same-day: docs-staleness sweep + #1346..#1362 entries
---
