...
last-verified: "2026-08-11" # agent-prompt refresh (audit A/B/E): prose/instructions surfaces only, no signature, payment authority, custody, or settle role changes. Per-change history: see "Verification log" at the end of this document
---
