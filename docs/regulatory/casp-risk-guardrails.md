...
last-verified: "2026-08-15" # #1482: /payments/:id/sign shape-checks prepared_user_op so an erc7710 chain cannot be submitted as a UserOp; characterization-first, unreachable today but no longer dependent on out-of-route checks. Entry in casp-changelog/2026-08-15-1482#1471: the backend gate accepts the spec-canonical base-sepolia literal; all four network maps now agree and the #1478 divergence list is empty. Entry in casp-changelog/2026-08-15-1471#1472: delegate_account_address exposed (derived, read-only, null on legacy) so merchant receipts map back to agents; demo receipt labels the payer honestly. Entry in casp-changelog/2026-08-15-1472#1469: null/non-object accepts[] entries refuse cleanly on every path — selectors skip them and the hosted tool normalizes agent input; a 500 becomes a 400, authority unchanged. Entry in casp-changelog/2026-08-15-1469.md. #1476: haven_sign refuses an unbound delegation payload — the last pass-through path closed, keyed on payload shape rather than tool choice. Entry in casp-changelog/2026-08-15-1476.md. #1456: erc7710 reachable from the hosted MCP surface — scheme selected server-side from rail + merchant advertisement, settle branches before the funding relay; 3009 byte-identical. Entry in casp-changelog/2026-08-15-1456.md. Prior #1456 (SDK half): settleX402Erc7710 split into prepare/submit so the hosted topology can drive it without ever holding a delegate key — refactor only. Entry in casp-changelog/2026-08-15-1456-sdk-split.md. #1455: the signer re-derives the settlement child's meaning from its caveats and refuses on disagreement or absence; enforcer addresses pinned + kit-cross-checked. Entry in casp-changelog/2026-08-15-1455.md. #1474: erc7710 authorize response gains x402_expected_auth — backend enablement only, no SDK consumer yet; binds the child digest, not its caveat semantics (#1455). Entry in casp-changelog/2026-08-15-1474.md. #1454: SDK gains the erc7710 direct-settlement path (no funding leg); authority unchanged, rail refused client-side as well as backend-side, live topology proof deferred to #1457. Entry in casp-changelog/2026-08-15-1454.md. #1453: SDK option selection reads extra.assetTransferMethod — closes the echo-7710-sign-3009 stranded-funds class; selection remains a client-side ask, validated backend-side per rail. Entry in casp-changelog/2026-08-15-1453.md. #1452: SDK signs the erc7710 settlement child (eip712_delegation) — verbatim, bounds already fixed by the backend and enforced on-chain by caveats; reachability change, not an authority change. Verification entry in casp-changelog/2026-08-15-1452.md. #1397: hosted MCP's new live-price quote tools are read-only session probes only — no intent, approval, signing context, funding, paid retry, or key handling; later paid calls still require a fresh quote and cap. #1366: verification entries move to docs/regulatory/casp-changelog/ shards (satisfied-by); this date tracks re-verification of the BODY claims only. EOF log below frozen as of 2026-08-12
---
