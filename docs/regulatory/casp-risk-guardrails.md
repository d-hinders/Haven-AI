...
last-verified: "2026-08-11" # #1321: hosted paid-MCP quote establishes a merchant MCP session with public delegate context before the unpaid tools/call; no signature, payment authority, custody, or settle role changes. Per-change history: see "Verification log" at the end of this document
---
