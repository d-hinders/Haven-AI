...
last-verified: "2026-08-11" # #1330: Hermes API identity moves from config YAML to owner-only .env; no signing, payment authority, custody, or settle role change. Per-change history: see "Verification log" at the end of this document
last-verified: "2026-08-11" # #1319: #1145 fallback provenance (remaining_is_from_chain) exposed on the GET /machine-payments/allowances wire, delegation-rail only, plus the #1306 preflight's new ALLOWANCE_READ_OPTIMISTIC warning and two review-flagged test gaps closed; no authority, route or refusal changed. Prior #1321: hosted paid-MCP quote establishes a merchant MCP session with public delegate context before the unpaid tools/call; no signature, payment authority, custody, or settle role changes. Per-change history: see "Verification log" at the end of this document
---
