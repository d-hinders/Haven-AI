...
#2413 no account, agent or dashboard surface displays them (§3 — the transaction
aggregation is not among the filtered queries and still spans every account row),
