...
Safe rows are untouched and still readable to a direct database query, though since
#2413 no account, agent or dashboard surface displays them (the transactions
