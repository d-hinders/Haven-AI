 ...
 *
 * The merchant-facing x402 window is bounded in the SDK
 * (X402_MAX_AUTHORIZATION_WINDOW_SECONDS, packages/sdk/src/x402.ts) with its
 * own tests; this file pins the backend-owned sweep window.
 */
