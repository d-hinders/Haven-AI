...
import { CLIENT_RELEASE_DATA } from './client-releases.data.js'
 ...
 * Typed HERE rather than in the data file, so the data file imports nothing
 * and no module cycle forms. Newest note first.
 */
