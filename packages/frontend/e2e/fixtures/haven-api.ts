  ...
  await page.route('**/api/**', async (route) => {
    ...
    if (method === 'POST' && path === '/agent-connection-setups') {
      ...
      await fulfillJson(route, {
        ...
        connector_command: 'npx -y @haven_ai/connect@0.1.1-alpha --setup hv_setup_e2e123 --api https://api.haven.example --ack-signer --runtime claude-code',
        setup_prompt: [
          'Please connect this workspace to Haven.',
          '',
          'Run this local setup command:',
          '',
          'npx -y @haven_ai/connect@0.1.1-alpha --setup hv_setup_e2e123 --api https://api.haven.example --ack-signer --runtime claude-code',
          '',
    ...
    if (method === 'GET' && path === '/agent-connection-setups/setup-e2e') {
      ...
      await fulfillJson(route, {
        ...
        runtime: 'claude-code',
        connector: { connector_version: '0.1.1', environment_label: 'Local workspace' },
        install_status: {
