  ...
  await page.route('**/api/**', async (route) => {
    ...
    if (method === 'POST' && path === '/agent-connection-setups') {
      ...
      await fulfillJson(route, {
        ...
        connector_command: 'npx -y @haven_ai/connect@0.1.2-alpha --setup hv_setup_e2e123 --api https://api.haven.example --ack-local-tools --runtime claude-code',
        setup_prompt: [
          'Please connect this workspace to Haven.',
          '',
          'Run this local setup command:',
          '',
          'npx -y @haven_ai/connect@0.1.2-alpha --setup hv_setup_e2e123 --api https://api.haven.example --ack-local-tools --runtime claude-code',
          '',
