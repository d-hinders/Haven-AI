  ...
  return (
    <div className={className}>
      ...
      <button
        ...
        disabled={isPending}
        className="h-10 w-full rounded-md border border-[var(--v2-border-strong)] bg-white px-4 text-sm font-medium text-[var(--v2-ink)] transition-colors hover:border-[var(--v2-brand)]/40 hover:bg-[var(--v2-surface)] disabled:cursor-not-allowed disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand/30"
      >
