...
const VARIANT_CLASS: Record<Variant, string> = {
  primary:
    'bg-[var(--v2-brand)] text-[var(--v2-ink-on-brand)] hover:bg-[var(--v2-brand-strong)] shadow-button focus-visible:ring-brand/80',
  ghost:
    'bg-[var(--v2-bg)] text-[var(--v2-ink)] border border-[var(--v2-border-strong)] hover:bg-[var(--v2-surface)] focus-visible:ring-brand/80',
  tertiary:
    'bg-transparent text-[var(--v2-ink-2)] hover:bg-[var(--v2-surface)] hover:text-[var(--v2-ink)] focus-visible:ring-brand/80',
  danger:
    'bg-[var(--v2-danger)] text-[var(--v2-ink-on-brand)] hover:bg-danger/90 shadow-button focus-visible:ring-danger/80',
}
