...
describe('generic skill', () => {
  ...
  it('directs the agent to runtime tools for identity, budget, and payment', () => {
    ...
    expect(skill).toContain('mcp__haven__haven_settle_mcp_tool')
    expect(skill).toContain('x402_expected')
    expect(skill).toContain('mcp__haven-signer__haven_sign')
    expect(skill).toContain('mcp__haven__haven_submit')
    expect(skill).toContain('mcp__haven-signer__haven_x402_sign_header')
    expect(skill).toContain('mcp__haven__haven_complete_mcp_tool')
