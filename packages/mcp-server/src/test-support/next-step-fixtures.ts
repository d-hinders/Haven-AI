...
export const EMISSION_SITES = [
  ...
  // #3271: haven_send / haven_pay success — the direct-payment byte-free handoff, agent-mediated by signer_compatibility (kept off this next-step census; it rides the result alongside these fields).
