 ...
 * 17 `buildAgentGuidance` sites (`EMISSION_SITES`) and the 28 refusal steps
 * (`REFUSAL_SITES`). Owned here so the characterization tests and the
 * cross-package parity walk read one list; the census constants live beside
 * their tests.
 */
