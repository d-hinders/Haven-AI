...
with three of the four #420 invariants asserted live (within-budget settle,
over-budget queue, x402 over-budget rejection). The full x402 **settle** (EIP-3009
signing of the authorization) and delegate **sweep recovery** are follow-ups.
...
| x402 settle (EIP-3009) | A within-budget x402 call settles via the merchant round-trip | follow-up (EIP-3009 signing) |
| sweep recovery | Stranded delegate balance is reclaimable after verify-without-settle | follow-up (needs verify-without-settle merchant mode) |
