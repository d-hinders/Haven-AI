...
const boundary: ClientBoundary = {
  ...
  privateOwnership: {
    ...
    'merchant-mcp': [
      'detectX402McpTransport',
      'mcpInitialize',
      'mcpNotifyInitialized',
      'merchantFetch',
      'readMcpMessage',
    ...
    'x402-state-and-funding': [
      'assertCanResumeX402',
      'attachResumeState',
      'attachX402ResumeState',
      'authorizeStandardX402',
      'buildX402Quote',
      'buildX402Receipt',
      'buildX402ResumeState',
      'cacheX402Receipt',
      'createStandardX402Header',
      'delegateCanFund',
      'mapX402ReceiptFromAuthorization',
      'mapX402ReceiptFromStatus',
