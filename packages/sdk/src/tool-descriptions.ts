...
export const toolDescriptions = {
  ...
  payX402: {
    ...
    nextActionGuidance:
      ...
      'Do not wait for a resume signal: this tool performs the merchant retry itself, and Haven emits no nextAction asking you to retry it. ' +
  ...
  resumeX402: {
    ...
    nextActionGuidance:
      'Not currently reachable: Haven emits no nextAction marking a payment ready to resume, so this call reports a conflict instead of retrying. ' +
      'If a paid request was interrupted after Haven authorized it, read haven_get_payment_status and tell the user what it reports. ' +
  ...
  payMcpTool: {
    ...
    nextActionGuidance:
      ...
      'This tool performs the merchant retry itself; there is no resume step to wait for.',
  },
  discoverTools: {
    summary:
